  ...
  return (
    <Footer>
      <Footer.Wrapper>
        <Footer.Row>
          <Footer.LogoColumn>
            <Footer.Logo src="./makerko.png" alt="logo"></Footer.Logo>
          </Footer.LogoColumn>
          <Footer.Column>
        ...
        <div className="pl-3 pr-3">
          <Footer.Copyright>Copyright(c) Makerko 2021</Footer.Copyright>
          <Footer.TermsAndPolicy>
            <Footer.TermsPolicy href="#">Privacy Policy</Footer.TermsPolicy> |{" "}
            <Footer.TermsPolicy href="#">Terms of Use</Footer.TermsPolicy>
          </Footer.TermsAndPolicy>
        </div>
      </Footer.Wrapper>
    </Footer>
