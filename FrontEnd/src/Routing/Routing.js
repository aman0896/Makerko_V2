        ...
        <div className="d-flex flex-column min-vh-100">
          <div className="wrapper flex-grow-1">
            ...
            <Switch>
              ...
              />
              <Route exact path="/makers/hub" component={MakersHub} />
              ...
              <Route exact path="/imageCropper" component={ImageCropperTest} />
              {/* <Route
                                exact
                                path="/create-project"
              ...
              {pathname !== null && pathname.includes("/profile") && (
                  ...
                  <div className="profile_section">
                    <Switch>
                      ...
                      <ProtectedRoute
                        ...
                        redirectionPage="/account/login"
                      />
                      {auth.userType && auth.userType === "customer" && (
                        <Fragment>
                          <Switch>
                            <ProtectedRoute
                      ...
                      {auth.userType && auth.userType === "maker" && (
                        <Fragment>
                          <Switch>
                            <ProtectedRoute
