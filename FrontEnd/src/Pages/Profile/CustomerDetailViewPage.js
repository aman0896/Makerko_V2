      ...
      getData(
        ...
        async (onSuccess) => {
          ...
          if (currentUserData[0] && currentUserData[0].CoverImage) {
            const imageData = JSON.parse(currentUserData[0].CoverImage);
          ...
          //profile image
          if (currentUserData[0] && currentUserData[0].Profile_Image) {
            const imageData = JSON.parse(currentUserData[0].Profile_Image);
            const imageBlob = await FileDownload(imageData.filePath);
    ...
    async function SetCoverImage() {
      ...
      if (featureProject) {
        for (let i = 0; i < featureProject.length; i++) {
          ...
          const imageBlob = await FileDownload(imageData.filePath);
          const previewUrl = window.URL.createObjectURL(new Blob([imageBlob]));
          data.push({
      ...
      {customer && (
        <>
          <img
            ...
            style={{
              width: "100%",
              height: width <= 500 ? "300px" : width <= 766 ? "400px" : "600px",
            ...
            >
              <div className="ml-md-5 d-flex align-items-center flex-column">
                <div className="bg-white stack-top px-4 py-3">
                  ...
                  <>
                    <div className="heading my-3">Contact</div>
                    <TextIconComponent
                      icon={<HiPhone />}
            ...
            <div className="col-md-7 mt-5 text-justify text-white">
              ...
              <div>
                ...
                <Button
                  buttonStyle="button--white--solid"
                  buttonSize={
                    width < 768 ? "button--large--100" : "button--large--50"
                  }
                >
                  <b>Get A Quote</b>
                </Button>
          ...
          >
            <>
              ...
              <TextIconComponent
                ...
                text={customer.Phone_Number}
              />
              <TextIconComponent icon={<MdMail />} text={customer.Email} />
              <TextIconComponent
                icon={<MdLocationOn />}
                text={customer.Address}
              />
