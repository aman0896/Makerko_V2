      ...
      {currentUserData && (
        <>
            ...
            {showImageCropper ? (
              ...
              <>
                <img
                  ...
                  alt=""
                />
                <label className="button cover-edit" htmlFor="cover-image">
                  <span>
                    <MdEdit style={{ margin: 1 }} />
                  </span>
                  <span style={{ margin: 1 }}>Edit Cover</span>
                </label>
          ...
          <div className="d-flex align-items-center flex-column my-4">
            ...
            <div className="profile-name">{currentUserData.Company_Name}</div>
          </div>
          ...
          >
            ...
            <div className="d-flex justify-content-end mt-4">
              <FormikController title="Update" type="submit" control="submit" />
            </div>
          </FormikComponent>
          ...
          <ChangePasswordComponent id={currentUserData.Manufacturer_ID} />
        </>
      )}
    </div>
  );
