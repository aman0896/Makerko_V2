  ...
  return (
    <div>
      ...
      <div className="main-box-2">
        ...
        >
          Hundreds of local makers with amazing manufacturing resources are
          waiting for your order. <br /> Do you have something cool to make it
          locally?
        </p>
        <a
          style={{
      ...
      <div className="main-box-4">
        <div className="main-sub-box-4">
          <div className="makers-col">
            <h2>Makers</h2>
            <p>
              Explore our manufacturing hubs to select from the portfolio of
              local makers. Users can sort and filter makers by their preferred
              company name, manufacturing process, material and location. Users
              know makers’ production capabilities, products, services,
              materials and rates by visiting their portfolio.
            </p>
            <Button2
              type="button"
            ...
            >
              <span>Explores </span>
              <span style={{ color: colors.primary }}>MAKERS</span>
            </Button2>
          ...
          <div className="project-col">
            <h2>Projects</h2>
            <p>
              Share what you make. Someone might be in need of it. The Makerko
              platform provides makers and innovators greater visibility to
              their business and product ideas. Explore featured projects to
              learn how local innovators and makers are applying manufacturing
            ...
            <a href="/create-project">
              Share your innovation/ product/ project to feature in our
              platform.
            </a>
          </div>
        </div>
      ...
      <div className="main-quote">
        ...
        >
          "Distributed Manufacturing is the Future of Production. It Helps you
          reach your market with near to zero investment in less time and
          minimum carbon footprint - all done locally."
        </span>
      </div>
