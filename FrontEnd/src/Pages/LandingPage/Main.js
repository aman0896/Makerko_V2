            ...
            <div>
                ...
                <div className="main-box-4">
                    <div className="main-sub-box-4">
                        <div className="makers-col">
                            <h2>Makers</h2>
                            <p>
                                Explore our manufacturing hubs to select from
                                the portfolio of local makers. Users can sort
                                and filter makers by their preferred company
                                name, manufacturing process, material and
                        ...
                        <div className="project-col">
                            <h2>Projects</h2>
                            <p>
                                Share what you make. Someone might be in need of
                                it. The Makerko platform provides makers and
                                innovators greater visibility to their business
                                and product ideas. Explore featured projects to
                                learn how local innovators and makers are
                ...
                <div className="main-quote">
                    ...
                    >
                        ...
                        is knowing which ones to keep.” - Susan Tamrakar
                    </span>
                </div>
